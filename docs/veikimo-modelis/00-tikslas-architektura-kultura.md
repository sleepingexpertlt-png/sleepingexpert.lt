...
- **K17** (2026-09-03, owner) — **Duomenų skaitymui naudojamas Porter Metrics
  (MCP). Windsor — tik pasižiūrėti, ne darbui.** Tiesioginės API prieigos VPS'e
  lieka: Google Ads — `src/agents/google_ads_agent.py` (`execute_gaql()`,
  customer 7015063449, **be MCC header'io**), GBP — `gmb_agent.py`.
